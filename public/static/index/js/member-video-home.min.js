$(function () {
    ...
    //     if (clickable) {
    //         $('.maincont').css({marginLeft: '75px'});
    //         $('#material-image').css({left: '-240px'});
    //         $('#material-music').css({left: '-240px'})
    //     }
    // });
...
function generateTab1(_obj, class_content) {
    ...
    target_obj.css({left: "60px"}).siblings('.' + class_content).css({left: "-240px"})
}
